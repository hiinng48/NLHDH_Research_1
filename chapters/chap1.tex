...
Các bài toán đồng bộ kinh điển thường được xây dựng dưới dạng tình huống đời sống như phòng đọc sách, qua sông, xe buýt ở trạm, tiệc sushi, bãi đỗ xe, thang máy hoặc bài toán ông già Noel. Mặc dù tên gọi có vẻ đơn giản, mỗi bài toán đều ẩn chứa một kiểu ràng buộc đồng bộ khác nhau: giới hạn số lượng tiến trình trong vùng găng, ghép nhóm đúng điều kiện, đánh thức tiến trình theo thứ tự, kiểm soát tài nguyên hữu hạn hoặc tránh để một nhóm tiến trình bị đói tài nguyên.
...
\begin{itemize}
    \item Bài toán Phòng đọc sách giới hạn (Room Party Problem).
    \item Bài toán Qua sông (River Crossing Problem / Hackers and Serfs).
    \item Bài toán Những người hút thuốc (Cigarette Smokers Problem).
    \item Bài toán Ông già Noel (Santa Claus Problem).
    \item Bài toán Tiệc ăn Sushi (Sushi Bar Problem).
    \item Bài toán Bữa ăn tập thể (Dining Savages Problem).
    \item Bài toán Thang máy (Elevator Problem).
    \item Bài toán Bãi đỗ xe giới hạn (Parking Lot Problem).
    \item Bài toán Trông trẻ (Child Care Problem).
    \item Bài toán Gấu và đàn ong (Bear and Honeybees Problem).
    \item Bài toán Ghép đội đấu hạng (Multiplayer Matchmaking Problem).
    \item Bài toán Xe buýt ở trạm (Senate Bus Problem).
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Chương 5:} Phân tích nhóm bài toán mô phỏng dịch vụ thực tế.
    \item \textbf{Chương 6:} So sánh các nhóm bài toán và tổng kết báo cáo.
\end{itemize}
