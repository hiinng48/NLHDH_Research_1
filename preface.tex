...
Đề tài \textbf{``Các bài toán đồng bộ tài nguyên găng''} được thực hiện nhằm hệ thống hóa một số bài toán kinh điển và mô hình thực tế thường dùng để mô phỏng các tình huống tranh chấp tài nguyên. Phạm vi báo cáo tập trung vào Room Party, River Crossing, Cigarette Smokers, Santa Claus, Sushi Bar, Dining Savages, Elevator, Parking Lot, Child Care, Bear and Honeybees, Multiplayer Matchmaking và Senate Bus. Các bài toán này đặt ra những ràng buộc khác nhau về số lượng tiến trình, thứ tự phục vụ, điều kiện ghép nhóm và quyền truy cập vào tài nguyên dùng chung.
...
\vspace{1.5cm}
\begin{flushright}
    \textit{Hà Nội, ngày 31 tháng 5 năm 2026} \\
    \vspace{0.2cm}
